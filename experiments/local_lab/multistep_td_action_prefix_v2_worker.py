"""Historical worker for the pre-result-rejected action-prefix TD v2 fixture.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "multistep-td-action-prefix-v2",
        ],
        required=True,
    )
    args = parser.parse_args()
    _disable_network()
    from experiments.local_lab.multistep_td_action_prefix_v2 import (
    ...
    result = (
        isolated_worker_trace()
        if args.mode == "multistep-td-action-prefix-v2-trace"
